      ...
      {loading ? (
        ...
        <>
          ...
          <div className="py-10 w-full max-w-7xl mx-auto">
            ...
            <div class="mt-5 grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
              <div class="px-4 pt-8">
                <p class="text-xl font-medium">Donation Summary</p>
                <p class="text-gray-400">
                  Check your selected items for donation
                </p>
                <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                  <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    <img
                      class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                      src="https://gwwomenincrisis.org/wp-content/uploads/2020/04/two-people-holding-hands-together-with-love-warmth-wooden-table.jpg"
                      alt=""
                    />
                    <div class="flex w-full flex-col px-4 py-4">
                      <span class="font-semibold">Donation 1 Title</span>
                      <span class="float-right text-gray-400">PKR 500</span>
                      <p class="text-lg font-bold">PKR 500</p>
                    </div>
                  </div>
                </div>
              </div>
